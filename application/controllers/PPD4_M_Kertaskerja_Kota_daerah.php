...
class PPD4_M_Kertaskerja_Kota_daerah extends CI_Controller {
    ...
    public function index(){
        if($this->input->is_ajax_request()){
            ...
            {                
                ...
                //common properties
                $this->js_init    = "main";
                $this->js_path    = "assets/js/ppd4/kertaskerja_daerah/kertaskerja_kota.js?v=".now("Asia/Jakarta");
        ...
        if($this->input->is_ajax_request()){
            try {
                ...
                $sql = "SELECT K.id mapid,K.id_kab, K.nama_kabupaten
                        ...
                        WHERE urutan='1' AND P.id=$satkercode ";

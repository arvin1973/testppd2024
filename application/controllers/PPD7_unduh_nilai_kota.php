 ...
 * date : 10 des 2020
*/
class PPD7_unduh_nilai_kota extends CI_Controller
{
    var $view_dir   = "ppd7/PPD7_unduh_nilai/";
    var $js_init    = "main";
    var $js_path    = "assets/js/ppd7/PPD7_unduh_nilai/ppd7.js";
    ...
    public function index()
    {
        if ($this->input->is_ajax_request()) {
            try {
                ...
                $this->js_init    = "main";
                $this->js_tedit    = "main";
                $this->js_path    = "assets/js/ppd7/PPD7_unduh_nilai/unduh_nilai_kota.js?v=" . now("Asia/Jakarta");


                $data_page = array();
                $str = $this->load->view($this->view_dir . "index_ppd7_kota", $data_page, TRUE);

<div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive isitable">
                                  <table id="listProv" class="table table-small-font table-bordered table-striped" style="width:100%">                          
                                    <thead>
                                        <tr>
                                            <th style="">Id</th>
    ...
    <div class="row _wrapper_wlyh" style="display: none">
    ...
    <div class="row _wrapper_bahan" style="display: none">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href='#' data-wlyh='' id='unduhsemua' class='btn btn-primary waves-effect waves-light' style='border-radius: 0px; padding-left: 10px; padding-right: 10px;margin-right: 5px; margin-bottom: 10px; float: right;'>Unduh Semua<i class='fas fa-download' style='padding-left: 5px;'></i></a>

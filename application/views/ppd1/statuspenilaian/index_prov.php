<div class="container-fluid">
                ...
                <div style="display: flex;">
                    <div class="card" style="color: white; border: 2px solid white; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
                        <div class="card-body" style="padding: 2px 8px;">
                            <p class="mb-0">Penilaian Provinsi TPT <i class="mdi mdi-numeric-1-box-outline" style="color: white;"></i></p>
                        </div>
                    </div>
                </div>
                <div class="page-title-right">
                ...
                <div class="row">
                    <div class="col-2" style="text-align: -webkit-center;">
                        <div class="avatar-md bg-info rounded-circle mr-2" style="height: 7rem; width: 7rem;">
                            <i class="ion ion-ios-book avatar-title font-56 text-white" style="font-size: 56px;"></i>
                        </div>
                    </div>
                    <div class="col-10">
                        <div class="media">
                            <div class="media-body align-self-center">
                                <div class="text-right">
                                    <h4 class="my-0 font-weight-bold"><span data-plugin="counterup" id="rekap_sudah_melakukan_penilaian">15852</span>/<span data-plugin="counterup" id="rekap_all_penilai">15852</span></h4>
                                    <p class="mb-0 mt-1 text-truncate">Pengguna yang sudah melakukan penilaian</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4">
                            <h6 class="text-uppercase">Percentage <span class="float-right" id="progress-penilaian">60%</span></h6>
                            <div class="progress progress-sm m-0">
                                <div class="progress-bar bg-info" role="progressbar" id="progress-bar-penilaian" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
                                    <span class="sr-only" id="span-progress-bar-penilaian">60% Complete</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <!-- <div class="col-md-6 col-xl-6">
                            <div class="card-box" style="background-color: aquamarine;">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <div class="text-right">
                                            <p class="mb-0 mt-1 text-truncate">Tim Penilai</p>
                                            <h4 class="font-20 my-0 font-weight-bold"><span data-plugin="counterup" id="rekap_belum_melakukan_penilaian">15852</span></h4>
                                            <p class="mb-0 mt-1 text-truncate">belum melakukan penilaian</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row stepper-status-penilaian-provinsi-tpt-penilaian">
        <!-- start page title -->
                ...
                <div style="display: flex;">
                    <div class="card" style="color: black; border: 2px solid rgba(49, 126, 235, 1); border-style: dashed; background-color: white; margin-bottom: 15px; margin-right: 1%;">
                        <a href="#" class="btnShwHd" data-show="._wrapper_wlyh,.stepper-status-penilaian-provinsi-tpt" data-hide="._wrapper_bahan,._wrapper_info" data-hdrhide=".lbl_hdr_nmwlyh" data-reload="kabko">
                            <div class="card-body" style="padding: 2px 8px;">
                                <p class="mb-0">Penilaian Provinsi TPT <i class="mdi mdi-numeric-1-box" style="color: #d1d1d1;"></i></p>
                            </div>
                        </a>
                    </div>
                    <div class="card" style="color: white; border: 2px solid white; border-style: dashed; background-color: rgba(49, 126, 235, 1); margin-bottom: 15px; margin-right: 1%;">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <!-- <button class="btn btn-warning btnShwHd" data-show="._wrapper_wlyh,.stepper-status-penilaian-provinsi-tpt" data-hide="._wrapper_bahan,._wrapper_info" data-hdrhide=".lbl_hdr_nmwlyh" data-reload="kabko"><i class="fas fa-arrow-left"></i>&nbsp;Kembali</button> -->
...
<!-- modal laporan berdasarkan penilaian -->
<!--                                     -->

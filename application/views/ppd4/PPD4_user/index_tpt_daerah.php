                        ...
                        <div class="tab-pane active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="card list_kabkota" style="">
                                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 5px;">
                                    ...
                                    <button data-toggle="modal" id="modal_add_kab" class="btn btn-info waves-effect waves-light" style="border-radius: 0px; padding-left: 10px; padding-right: 10px;margin-right: 5px; margin-bottom: 10px; float: right;"><i class="fa fa-plus"></i> Tambah Data</button>
                                </div>
...
<form id="form_kab">
    <div id="list_kab" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <select class="form-control selectpicker" id="kabkot_select" data-width="100%" multiple="multiple" name="kk[]" data-actions-box="true" data-live-search="true">

...
<!--            <div class="col-lg-4">
                <div class="card-box" style="background-color: rgba(255, 152, 0, 0.1); border: 2px solid rgba(255, 152, 0, 0.5); border-radius: 5px; padding: 10px 20px 10px 20px;">
                    <div class="media">
                    ...
                    <div class="mt-0">
                        <p style="margin-bottom: 0px; color: #98a6ad !important; font-size: 0.7rem;"><b>Progress</b> : 2/3 Completed</p>
                        <div class="progress progress-sm" style="margin-bottom: 0px;">
                            <div class="progress-bar bg-pink progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="66.6" aria-valuemin="0" aria-valuemax="100" style="width: 66.6%; background-color: #ef5350!important;">
            ...
            <div class="col-lg-4">
                <div class="card-box" style="background-color: rgba(38, 166, 154, 0.2); border: 2px solid rgba(38, 166, 154, 0.5); border-radius: 5px; padding: 10px 20px 10px 20px;">
                    <div class="media">
                        <div class="media-body align-self-center">
                            <div class="text-left">
            ...
            <div class="col-lg-4">
                <div class="card-box" style="background-color: rgba(141, 110, 99, 0.1); border: 2px solid rgba(141, 110, 99, 0.5); border-radius: 5px; padding: 10px 20px 10px 20px;">
                    <div class="media">
                        <div class="media-body align-self-center">
                            <div class="text-left">
                ...
                <div class="card-body">
                    <div style="overflow-x: auto;">
                        <table class="table-description table-modified">
                            ...
                            <tr style="">
                                <td  class="text-uppercase lbl_hdr_katewlyh lbl_katewlyh">Provinsi</td>
                                <td>:</td>
                                <td class="lbl_hdr_nmwlyh"></td>
                            </tr>
                            <tr style="display: none">
                                <td  class="text-uppercase">Aspek</td>
                                <td>:</td>
                                <td class="lbl_hdr_aspk"></td>
                            </tr>
                            <tr style="display: none">
            ...
            <div class="col-12" style="background-color: #f1f1f1; position: fixed; z-index: 98; border-bottom: 1px solid rgba(49, 126, 235, 0.3); margin-top: 5px;">
                <div class="page-title-box" style="padding: 10px 0px 0px 20px; margin: 0px;">
                    ...
                    <div style="display: flex;">
                        ...
                        <a href="#" class="btnShwHd" data-show="._wrapper_katewlyh" data-hide="._wrapper,._wrapper_info" data-hdrhide=".lbl_hdr_nmwlyh"><p style="padding: 5px; font-size: 0.8rem !important;"><strong><i class="mdi mdi-undo" style="color: #2ad408;"></i> Kembali</strong></p></a>
                    </div>
                    <div class="page-title-right">
                        <!-- <ol class="breadcrumb p-0 m-0">
                            <li class="breadcrumb-item"><a href="#">Moltran</a></li>
            ...
            <div class="col-12">
                <div class="card" style="border: 1px solid rgba(49, 126, 235, 1); min-height: 125px;">
                    ...
                    <div class="card-body">
                        <div class="text-left">
                            <p class="mb-0"><b>Penilaian</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Modul 1</p>
                            <p class="mb-0"><b>Wilayah Penilaian</b> &nbsp;: Provinsi</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    ...
                    <ul class="" style="list-style: none;padding-left: 10px">
                        ...
                        <li><button type="button" class="btn btn-sm btn-success waves-effect waves-light" style="border-radius: 0px; margin-bottom: 5px; padding-left: 10px; padding-right: 10px;">Mulai Penilaian <i class="fa fa-caret-right" style="padding-left: 5px;"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;<em>Mulai Penilaian</em></li>
                        <li><button type="button" class="btn btn-sm btn-warning waves-effect waves-light" style="border-radius: 0px; margin-bottom: 5px; padding-left: 10px; padding-right: 10px;"><i class="fas fa-exclamation"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;<em>Lengkapi Resume Aspek</em></li>
                        <li><button type="button" class="btn btn-sm btn-warning waves-effect waves-light" style="border-radius: 0px; margin-bottom: 5px; padding-left: 10px; padding-right: 10px; background-color: #33b86c;"><i class="fas fa-check-circle"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;<em>Lengkapi Lembar pernyataan</em></li>
                        <li><button type="button" class="btn btn-sm btn-warning waves-effect waves-light" style="border-radius: 0px; margin-bottom: 5px; padding-left: 10px; padding-right: 10px; background-color: #29b6f6;"><i class="fas fa-check-circle"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;<em>Lengkap</em></li>
                    </ul>
                </div>
            ...
            <div class="col-12" style="background-color: #f1f1f1; position: fixed; z-index: 98; border-bottom: 1px solid rgba(49, 126, 235, 0.3); margin-top: 5px;">
                <div class="page-title-box" style="padding: 10px 0px 0px 20px; margin: 0px;">
                    ...
                    <div style="display: flex;">
                        ...
                        <a href="#" class="btnShwHd" data-show="._wrapper_wlyh"  data-hide="._wrapper,._wrapper_info" data-hdrhide=".lbl_hdr_nmwlyh"  data-reload="prov"><p style="padding: 5px; font-size: 0.8rem !important;"><strong><i class="mdi mdi-undo" style="color: #2ad408;"></i> Kembali</strong></p></a>
                    </div>
                    <div class="page-title-right">
                        <!-- <ol class="breadcrumb p-0 m-0">
                            <li class="breadcrumb-item"><a href="#">Moltran</a></li>
            ...
            <div class="col-12">
                <div class="card" style="border: 1px solid rgba(49, 126, 235, 1); min-height: 125px;">
                    ...
                    <div class="card-body">
                        <div class="text-left">
                            <p class="mb-0"><b>Wilayah Penilaian</b>&nbsp; : Provinsi</p>
                            <p class="mb-0"><b>Daerah</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Provinsi Aceh</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-bordered table-hover" id="t_indi">
                                <thead>
                                    <tr>
                                        ...
                                        <th class=""style="width:10px">Status</th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div class="col-12" style="background-color: #f1f1f1; position: fixed; z-index: 98; border-bottom: 1px solid rgba(49, 126, 235, 0.3); margin-top: 5px;">
                <div class="page-title-box" style="padding: 10px 0px 0px 20px; margin: 0px;">
                    ...
                    <div style="display: flex;">
                        ...
                        <a href="#" class="btnShwHd" data-show="._wrapper_indi" data-hide="._wrapper" data-hdrhide=".lbl_hdr_indi,.lbl_hdr_krit,.lbl_hdr_aspk" data-reload="indi"><p style="padding: 5px; font-size: 0.8rem !important;"><strong><i class="mdi mdi-undo" style="color: #2ad408;"></i> Kembali</strong></p></a>
                    </div>
                    <div class="page-title-right">
                        <!-- <ol class="breadcrumb p-0 m-0">
                            <li class="breadcrumb-item"><a href="#">Moltran</a></li>
                            ...
                            <table class="table table-bordered " id="t_item">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        <th class="text-uppercase text-vertical-center" title="No Urut" rowspan="2"><center>NO</center></th>
                                        <th class="text-uppercase text-vertical-center" rowspan="2"><center>NAMA ITEM</center></th>
                                        <th class="text-uppercase text-vertical-center" colspan="2"><center>INDIKATOR PENILAIAN</center></th>
                                        <th class="text-uppercase text-vertical-center" rowspan="2"><center>SKOR</center></th>
                                    </tr>
                                    <tr class="bg-primary text-white">
        ...
        <div class="modal-content">
            <div class="card card-color mb-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group" style="margin-bottom: 0px;">
                                <label for="field-1" class="control-label">Dokumen Lembar Kerja   <span class="text-danger" style="font-size: 12px">  * wajib diisi</span></label>
                                <div class="row">
                                    <div class="d-flex">
                    ...
                    <!-- <pre> -->
                        <div class="row">
                            <div class="col-md-12"><p>Dengan ini saya menyatakan bahwa penilaian ini dilakukan secara profesional, jujur, bertanggung-jawab, dan tidak atas dasar tekanan dari pihak manapun.</p><br><p>Demikian pernyataan ini.</p></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-condensed table-bordered table-striped " id="t_doc" style="border: 1px solid black; margin-bottom: 0px; border-collapse: inherit;">
                                <thead style="background-color: rgb(31, 56, 100) !important; color: white;">
                                    <tr>
                                        <td class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>No</b></center></td>
                                        <td class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>Judul</b></center></td>
                                        <td class="text-uppercase" style="padding: 3px; padding-left: 10px; padding-right: 10px; border: 1px solid black;"><center><b>Tautan</b></center></td>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            </table>

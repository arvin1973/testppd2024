...
//                     { "width": "80px", "targets": 2}                     
     ...
     //                console.log(settings);
        ...
        $(".tambah_list_daerah_tptd").on('click', function() {
            var id = $("#inp_user").val();
            // console.log(id);
            jQuery.ajax({
                type: "POST", // HTTP method POST or GET
                url: controller+"/list_kabkot_by_prov", //Where to make Ajax calls
                dataType:"text", // Data type, HTML, json etc.
                ...
                success:function(response){
                    ...
                    for (let index = 0; index < data.length; index++) {
                        ...
                        select += '<option value="'+data[index]['encriptId']+'" data-subtext="'+data[index]['nama_provinsi']+'">'+data[index]['id_kab']+' - '+data[index]['nama_kabupaten']+'</option>';                        
                    }

                    $('#list_kabkot').append(select);
                },
                error:function (xhr, ajaxOptions, thrownError){
                    loading.hide(); 
                    alert(thrownError);

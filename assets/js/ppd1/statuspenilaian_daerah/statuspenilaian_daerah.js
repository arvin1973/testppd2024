var main = function(){
    controller = "PPD1_status_penilaian_daerah";
    var datatable = function(){
        ...
        $(document).on('click', '#rekapall', function(e) {
            e.preventDefault();
            var prov = $(this).data('pr');
            window.open(base_url + controller + "/allrekap?provid=" + prov); 
        });
        ...
        $("#rekap_penilaian_by_user").click(function(e){
            window.open(base_url+controller+"/rekap_penilaian_tpt_by_user/"+$("#inp_wlyh").val()); 
        });

        $("#rekap_penilaian_daerah").click(function(e){
            window.open(base_url+controller+"/rekap_penilaian_daerah_by_tpt/"+$("#inp_wlyh").val()); 
        });

        $("#rekap_resume_by_user").click(function(e){
            window.open(base_url+controller+"/rekap_resume_tpt_by_user/"+$("#inp_wlyh").val()); 
        });
